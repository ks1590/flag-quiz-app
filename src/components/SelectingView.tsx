        ...
        {!difficulty ? (
          <>
            ...
            <div className='space-y-4'>
              <button
                onClick={() => setDifficulty('level0')}
                className='w-full py-4 bg-teal-500 text-white text-xl font-bold rounded-full shadow-lg hover:bg-teal-600 transform hover:scale-105 transition-all'>
                レベル0 (20<Ruby rt='かこく'>カ国</Ruby>)
              </button>
              <button
